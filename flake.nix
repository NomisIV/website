  ...
  outputs = { self, nixpkgs, diosevka, servera }:
    ...
    with lib;
    {
      ...
      in {
        ...
        config = lib.mkIf cfg.enable {
          systemd.services.nomisiv-website = {
            ...
            serviceConfig = {
              ExecStart =
                "${servera.packages.x86_64-linux.default}/bin/servera \
      ...
      packages.x86_64-linux.default = mkSite "nomisiv.com" (let
        ...
        customHtmlTemplate = { title, body, extraSubs ? { } }:
          htmlTemplate (let
            description = pkgs.lib.strings.escapeXML
      ...
      in {
        ...
        assets = {
          ...
          fonts = diosevka.packages.x86_64-linux.woff2
          ...
          "index.html" = customHtmlTemplate {
            ...
            extraSubs = {
              blog = builtins.concatStringsSep "\n" (
                ...
                (
                  value:
                  "- [${value.date} ${value.title}](/blog/${linkOf value})"
                )
                blogPagesList
              );
            };
